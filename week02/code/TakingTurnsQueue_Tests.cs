...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Que returns players in the wrong order. This indicates the players are not reinserted
    // into the que correctly.
    ...
    // Defect(s) Found: Que order is returning the incorrect person. Expects Tim but actaully gets Sue.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Players are not ordered correctly. Expects Tim but actually gets Sue.
